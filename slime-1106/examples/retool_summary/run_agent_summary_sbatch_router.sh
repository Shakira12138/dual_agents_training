...
NO_PROXY_LIST="localhost,127.0.0.1,${MASTER_ADDR},${HOST_IP},kb3-a1-nv-dgx-*"
...
HF_CKPT_PATH=${HF_CKPT_PATH:-"/work/projects/polyullm/models/Qwen3/Qwen3-4B"}
DIST_CKPT_PATH=${DIST_CKPT_PATH:-"/work/projects/polyullm/models/Qwen3-4B_torch_dist"}

LOAD_DIR=${LOAD_DIR:-/work/projects/polyullm/zhouqi/dual_agent/summary-agent_test23}
SAVE_DIR=${SAVE_DIR:-/work/projects/polyullm/zhouqi/dual_agent/summary-agent_test23}

# reward model for llm-as-judge
export JUDGE_MODEL_BASE_URL=${JUDGE_MODEL_BASE_URL:-http://kb3-a1-nv-dgx36:40000/v1}
export JUDGE_MODEL_NAME=${JUDGE_MODEL_NAME:-gpt-oss-120b}
...
# 使用异步训练模式（train_async.py）
# 异步训练可以在训练当前 rollout 时提前开始下一个 rollout 的数据生成
# 注意：train_async.py 不支持 --colocate 参数
